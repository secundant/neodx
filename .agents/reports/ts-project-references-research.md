...
| Date          | 2026-08-05                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Tip / branch  | neodx `improve/neodx` (PR [#160](https://github.com/secundant/neodx/pull/160)); research @ S3/`b9fc972`-line; **cutover** after `1579d67` — see [implementation](./ts-project-references-implementation.md).                                                                                                                                                                                                                                                                                                                                                                        |
