...
| [ts-project-references-implementation.md](./ts-project-references-implementation.md) | Cutover after-report        | Unified lib `tsc -b`; S5-R2-a **BLOCK** (pack dts); remove `vite-tsconfig-paths` with H4 |
