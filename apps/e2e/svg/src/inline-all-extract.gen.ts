...
export const sprites = defineSpriteMap([
  defineSprite('inline-all-extract', [
    defineSpriteAsset(
      [
        defineSpriteSymbol(['add', 'inline-all-extract-add-d1e7ceb4'], [16]),
        defineSpriteSymbol(['animated-mask', 'inline-all-extract-animated-mask-5f551070'], [200]),
        defineSpriteSymbol(
          ['animated-pattern', 'inline-all-extract-animated-pattern-cc20ebf7'],
          [200]
        ),
        defineSpriteSymbol(
          ['animated-symbol', 'inline-all-extract-animated-symbol-54cc15ca'],
          [200]
        ),
        defineSpriteSymbol(['checkmark', 'inline-all-extract-checkmark-a60a1b79'], [16]),
        defineSpriteSymbol(['close', 'inline-all-extract-close-6690626c'], [16]),
        defineSpriteSymbol(
          ['combined-filter', 'inline-all-extract-combined-filter-0c0e9338'],
          [200]
        ),
        defineSpriteSymbol(['dynamic-filter', 'inline-all-extract-dynamic-filter-c60a732e'], [200]),
        defineSpriteSymbol(['favourite', 'inline-all-extract-favourite-476f15b3'], [48]),
        defineSpriteSymbol(['flag-ad', 'inline-all-extract-flag-ad-fc4f87b1'], [512]),
        defineSpriteSymbol(['flag-uk', 'inline-all-extract-flag-uk-c3391966'], [512]),
        defineSpriteSymbol(['folder-colored', 'inline-all-extract-folder-colored-cd78d9d5'], [16]),
        defineSpriteSymbol(['hex-a-fill', 'inline-all-extract-hex-a-fill-d80501b9'], [16]),
        defineSpriteSymbol(
          ['linear-gradient', 'inline-all-extract-linear-gradient-0540f7a7'],
          [100]
        ),
        defineSpriteSymbol(
          ['mixed-animation-pattern', 'inline-all-extract-mixed-animation-pattern-141ec3ea'],
          [200]
        ),
        defineSpriteSymbol(['mixed-gradient', 'inline-all-extract-mixed-gradient-836b6a20'], [200]),
        defineSpriteSymbol(
          ['simple-hex-upper', 'inline-all-extract-simple-hex-upper-38564154'],
          [16]
        )
      ],
      defineFetchAndInjectedAssetMeta('inline-all-extract.svg')
    )
  ])
]);
