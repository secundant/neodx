...
export const sprites = defineSpriteMap([
  defineSprite('no-inline', [
    defineSpriteAsset(
      [
        defineSpriteSymbol(['add'], [16]),
        defineSpriteSymbol(['animated-mask'], [200]),
        defineSpriteSymbol(['animated-pattern'], [200]),
        defineSpriteSymbol(['animated-symbol'], [200]),
        defineSpriteSymbol(['checkmark'], [16]),
        defineSpriteSymbol(['close'], [16]),
        defineSpriteSymbol(['combined-filter'], [200]),
        defineSpriteSymbol(['dynamic-filter'], [200]),
        defineSpriteSymbol(['favourite'], [48]),
        defineSpriteSymbol(['flag-ad'], [512]),
        defineSpriteSymbol(['flag-uk'], [512]),
        defineSpriteSymbol(['folder-colored'], [16]),
        defineSpriteSymbol(['hex-a-fill'], [16]),
        defineSpriteSymbol(['linear-gradient'], [100]),
        defineSpriteSymbol(['mixed-animation-pattern'], [200]),
        defineSpriteSymbol(['mixed-gradient'], [200]),
        defineSpriteSymbol(['simple-hex-upper'], [16])
      ],
      defineExternalAssetMeta('no-inline.svg')
    )
  ])
]);
