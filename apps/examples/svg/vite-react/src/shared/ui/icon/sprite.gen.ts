...
export const sprites = defineSpriteMap([
  ...
  defineSprite('other', [
    ...
    defineSpriteAsset(
      [
        defineSpriteSymbol('de', 512, 512, undefined, 'other-de-3f6dc3fa'),
        defineSpriteSymbol('es', 512, 512, undefined, 'other-es-3a001c14'),
        defineSpriteSymbol('fr', 512, 512, undefined, 'other-fr-1d0c12a2'),
        defineSpriteSymbol('it', 512, 512, undefined, 'other-it-8f3ce995'),
        defineSpriteSymbol('ru', 512, 512, undefined, 'other-ru-cd36b52b'),
        defineSpriteSymbol('uk', 512, 512, undefined, 'other-uk-88169c65'),
        defineSpriteSymbol('us', 512, 512, undefined, 'other-us-7f3012f5')
      ],
      defineInjectedAssetMeta(
