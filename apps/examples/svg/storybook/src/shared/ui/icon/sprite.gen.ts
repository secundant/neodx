...
export const sprites = defineSpriteMap([
  defineSprite('general', [
    ...
    defineSpriteAsset(
      [
        defineSpriteSymbol(['ide-update', 'general-ide-update-cb003579'], [16]),
        defineSpriteSymbol(['plugin-update', 'general-plugin-update-8d92d1c1'], [16])
      ],
      defineInjectedAssetMeta(
        '<svg width="0" height="0"><defs><clipPath id="general-ide-update-ref-a-cb003579"><path fill="var(--icon-secondary-color)" d="M0 0h16v16H0z"/></clipPath><clipPath id="general-plugin-update-ref-a-8d92d1c1"><path fill="var(--icon-secondary-color)" d="M16 0H0v16h16z"/></clipPath></defs><symbol xmlns="http://www.w3.org/2000/svg" id="general-ide-update-cb003579" fill="none" viewBox="0 0 16 16"><g fill="var(--icon-secondary-color)" clip-path="url(#general-ide-update-ref-a-cb003579)"><path d="m8.5 5.207 2.646 2.647a.5.5 0 0 0 .708-.708l-3.5-3.5a.5.5 0 0 0-.708 0l-3.5 3.5a.5.5 0 1 0 .708.708L7.5 5.207V12a.5.5 0 0 0 1 0z"/><path fill-rule="evenodd" d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m0-1A7 7 0 1 0 8 1a7 7 0 0 0 0 14" clip-rule="evenodd"/></g></symbol><symbol xmlns="http://www.w3.org/2000/svg" id="general-plugin-update-8d92d1c1" fill="none" viewBox="0 0 16 16"><g fill="var(--icon-secondary-color)" clip-path="url(#general-plugin-update-ref-a-8d92d1c1)"><path d="m8.5 5.207 2.646 2.647a.5.5 0 0 0 .708-.708l-3.5-3.5a.5.5 0 0 0-.708 0l-3.5 3.5a.5.5 0 1 0 .708.708L7.5 5.207V12a.5.5 0 0 0 1 0z"/><path fill-rule="evenodd" d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m0-1A7 7 0 1 0 8 1a7 7 0 0 0 0 14" clip-rule="evenodd"/></g></symbol></svg>'
      )
    )
  ]),
  defineSprite('other', [
    ...
    defineSpriteAsset(
      [
        ...
        defineSpriteSymbol(['es', 'other-es-e9ca8731'], [512]),
