...
export interface GetImageParams extends FileKeyParams {
  ...
  /** Use the full dimensions of the node regardless of whether it is cropped or the surrounding space is empty. Use this to export text nodes without cropping. `Default: false` */
