...
export const sprites = defineSpriteMap([
  defineSprite('sprite', [
    defineSpriteAsset(
      [
        defineSpriteSymbol('close', 48, 48),
        defineSpriteSymbol('exit', 16, 16),
        defineSpriteSymbol('favourite', 48, 48),
        defineSpriteSymbol('folder-colored', 16, 16),
